...
class HomePageViewController: UIViewController, AVCaptureVideoDataOutputSampleBufferDelegate, UITextFieldDelegate {
    ...
    // This event is fired when the detedted item is clicked
    ...
    // Fetch food item nutrition info when the return key is pressed from the text field
    ...
    // This method start scanning and captures frames from camera and display camera live vide in VIEW
    ...
    // This method captures the frames of camera and send it to ImageClassifier.mlmodel for object identification and gets back the result.
